...
function useStyles(th, dark) {
  return useMemo(() => ({
    app: { fontFamily:"'DM Sans',system-ui,sans-serif", background:th.bg, color:th.text, minHeight:"100dvh", maxWidth:430, margin:"0 auto", position:"relative", paddingTop:"calc(56px + env(safe-area-inset-top, 0px))", paddingBottom:"calc(96px + env(safe-area-inset-bottom,20px))", paddingLeft:"env(safe-area-inset-left, 0px)", paddingRight:"env(safe-area-inset-right, 0px)", overflowX:"hidden", width:"100%" },
    header: { padding:"10px 16px 10px", paddingTop:"calc(10px + env(safe-area-inset-top, 0px))", display:"flex", alignItems:"center", justifyContent:"space-between", position:"fixed", top:0, left:"50%", transform:"translateX(-50%)", width:"100%", maxWidth:430, zIndex:40, background:dark?"rgba(11,18,22,0.92)":"rgba(242,244,237,0.92)", backdropFilter:"blur(24px) saturate(180%)", boxSizing:"border-box" },
